...
$(document).ready(function(){
	...
	$('#btn_add').click(function() {
		...
		$.ajax({
			url : oCalendar.base_url() +'calendar/add_record',
			type : 'post',
			data : {event:event,from:from,to:to,location:location,date:date},
	...
	$('#calendar_table tbody tr').live('click',function() {
		var obj = $(this);
	...
	$('#btn_update').click(function() {
		...
		$.ajax({
			url : oCalendar.base_url() + 'calendar/update_record',
			type : 'post',
			data : {id:id,data:{event:event,from_time:from,to_time:to,location:location}},
			success : function(data){
				if(data == 1){
					// update event list
	...
	$('#btn_delete').click(function() {
		...
		$.ajax({
			url : oCalendar.base_url() + 'calendar/delete_record',
			type : 'post',
...
var oCalendar = {
	...
	base_url : function() {	return  $('#base_url').val();},
	
	getRecord : function(iCmonth,iCyear)
	{
		$.ajax({
			url : oCalendar.base_url()+'calendar/get_data',
			type : 'post',
			dataType : 'json',
			data : {month:iCmonth,year:iCyear},
			success : function(data){
	...
	{
		$.ajax({
			url : oCalendar.base_url()+'calendar/get_by_date_record',
			type : 'post',
			dataType : 'json',
			data : {search:sSearch},
			success : function(data){
