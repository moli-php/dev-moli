		...
		$.each(aData, function(k,v) {
			...
			$.each(choices, function(key,val){
				...
				str += '<div class="col-md-3" >\
						...
						<div class="col-md-12"><img width="100" src="'+base_url+'assets/img/animals/'+val.id+'.jpg" class="img-rounded '+user_answer+'"/></div></center>\
						</div>';
			});
				str += '</div>';
...
var quiz = {
	...
	var result = "";
		$.ajax({
			url : base_url + 'animalquiz/up_to/'+num,
			dataType : 'json',
			async : false,
		...
		$.each(data, function(k,v){
			...
			str += '<div class="row" '+is_hide+' data-index="'+(k+1)+'">\
				<div class="col-md-8 well">\
					...
					<div class="col-md-3 well btn btn_hover" data-id="'+choices[0].id+'"><img src="'+base_url+'assets/img/animals/'+choices[0].id+'.jpg" class="img-rounded"/></div>\
					<div class="col-md-3 well btn btn_hover" data-id="'+choices[1].id+'"><img src="'+base_url+'assets/img/animals/'+choices[1].id+'.jpg" class="img-rounded"/></div>\
					<div class="col-md-3 well btn btn_hover" data-id="'+choices[2].id+'"><img src="'+base_url+'assets/img/animals/'+choices[2].id+'.jpg" class="img-rounded"/></div>\
					<div class="col-md-3 well btn btn_hover" data-id="'+choices[3].id+'"><img src="'+base_url+'assets/img/animals/'+choices[3].id+'.jpg" class="img-rounded"/></div>\
					</span>\
