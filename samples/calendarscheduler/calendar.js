...
$(document).ready(function(){
	...
	$('#btn_add').click(function() {
		...
		$.ajax({
			url : oCalendar.base_url() +'service/add_record',
			type : 'post',
	...
	$('#btn_update').click(function() {
		...
		$.ajax({
			url : oCalendar.base_url() + 'service/update_record/',
			type : 'put',
	...
	$('#btn_delete').click(function() {
		...
		$.ajax({
			url : oCalendar.base_url() + 'service/delete_record',
			type : 'delete',
...
var oCalendar = {
	...
	{
		$.ajax({
			url : oCalendar.base_url()+'service/get_data',
			type : 'post',
			dataType : 'json',
	...
	{
		$.ajax({
			url : oCalendar.base_url()+'service/get_by_date_record',
			type : 'post',
			dataType : 'json',
			data : {search:sSearch},
			success : function(data){
